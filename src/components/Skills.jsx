...
const Skills = () => {
  return (
    <div name="skills" className="w-full h-screen bg-[#e77728]">
      {/* Container */}
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div>
          ...
          <p className="py-4 text-2xl sm:text-2xl font-bold text-[#495b67]">These are the technologies I've worked with</p>
        </div>
